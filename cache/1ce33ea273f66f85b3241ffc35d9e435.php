		...
		<div id="page" class="site">
			...
			<div id="content" class="site-content site_container container clear">
				<div id="primary" class="content-area full-width">
					<div class="img">
						<a href="<?php echo $this->value['CUrl']; ?>" title="<?php echo $this->value['Name']; ?>"><img src="<?php echo $this->value['Pic']; ?>" alt="<?php echo $this->value['Name']; ?>"
								class="imgPlay" style="width: 100%;"></a>
					</div>
					<div class="info">
						<dl>
							<dd><?php echo $this->value['Name']; ?></dd>
						</dl>
						<dl class="dl-left mb-dl-left">
							<dd><?php echo $this->value['Time']; ?></dd>
						</dl>
						...
						<dl class="dl-left mb-dl-left"><a style="color: #fff;" class="play" href="<?php echo $this->value['CUrl']; ?>">立即播放</a></dl>
